...
(function () {
    ...
    function insert(editor, str, from, to) {
        editor.replaceRange(str, from, to);
        if (str.indexOf("(") !== -1 && str.indexOf(")") !== -1) {
            var f = { line: from.line, ch: from.ch };
            f.ch = f.ch + str.indexOf("(") + 1;
            var t = { line: from.line, ch: from.ch };
            t.ch = t.ch + str.lastIndexOf(")");
            if (f.ch < t.ch)
                editor.setSelection(f, t);
        }
    ...
    Completion.prototype = {
        ...
        pick: function (data, i) {
            ...
            else insert(this.cm, getText(completion), data.from, data.to);//this.cm.replaceRange(getText(completion), data.from, data.to);
            this.close();
        },
