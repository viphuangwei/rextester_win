...
}; this.onResizerMouseDown = function (a) {var h = (window.event) ? a.srcElement ? a.target : a.srcElement : a.target
, f = $(h).closest(".mdd_resizer_wrap").prev(".mdd_editor_wrap").children("textarea")[0], l = a.clientY, k = $
